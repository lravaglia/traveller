...
const copyBash = () => {
  const bash = 'git clone https://github.com/lravaglia/traveller'
      ...
      <PageSection class="flex-1 flex items-center">
        <div class="flex-1 md:w-5/8 flex flex-col z-10">
          ...
          >
            ...
            <Button
              ...
              type="secondary"
              class="font-extrabold"
              href="https://github.com/lravaglia/traveller"
            />
          </div>
        </div>
        <div class="hidden md:flex md:w-3/8 justify-center items-end relative">
          ...
          <div class="ml-4 w-100 z-10 h-auto shadow">
            ...
            >
              <div>$ git clone https://github.com/lravaglia/traveller</div>
            </div>
          </div>
        </div>
      </PageSection>
